...
import "./Qtransfer4.css";

export default function Qtransfer3() {
  ...
  return (
    <div className="Quick-Transfer">
      <h1 className="h1-1">Balance Enquiry</h1>
      <h3 className="h3-3">To open Quick Balance Enter transaction pin</h3>
