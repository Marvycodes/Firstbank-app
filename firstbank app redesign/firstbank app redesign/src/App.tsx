...
import Firstbank from "./Firstbank.tsx";
import Otherbanks from "./Otherbanks.tsx";
import FXsales from "./FXsales.tsx";
import Beneficiaries from "./Beneficiaries.tsx";
import Enaira from "./Enaira.tsx"
    ...
    <div>
      <Router>
        <Routes>
          ...
          <Route path="/quick transfer" element={<About />} />
          ...
          <Route path="/homepage/transfer/firstbank" element={<Firstbank />} />
          <Route
            path="/homepage/transfer/tootherbanks"
            element={<Otherbanks />}
          />
          <Route path="/homepage/transfer/fxsales" element={<FXsales />} />
          <Route
            path="/homepage/transfer/Sendbeneficiaries"
            element={<Beneficiaries />}
          />
           <Route
            path="/homepage/transfer/eNaira"
            element={<Enaira />}
          />
        </Routes>
      </Router>
